...
- 以下の6種類のおみくじ結果がランダムで表示されます：
  ...
  - 大凶 (Great Curse)
- 日本語と英語の言語切り替えが可能
  - 左上の言語切り替えボタン（EN/JA）をクリックして切り替え
  - 言語設定はローカルストレージに保存され、次回アクセス時も保持されます
  - UIテキストとおみくじ結果が選択した言語で表示されます
...
1. 左上の言語切り替えボタン（EN/JA）で日本語と英語を切り替えられます
2. 右上のテーマ切り替えボタン（🌙/☀️）でライトテーマとダークテーマを切り替えられます
3. 「おみくじを回す」（または「Draw Fortune」）ボタンをクリックします
4. ランダムでおみくじ結果が表示されます
5. 何度でもおみくじを回すことができます
